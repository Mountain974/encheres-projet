...
public class ArticleVenduDTO {
    ...
    public ArticleVenduDTO(Long noArticle, String nom, String description, LocalDate dateDebutEncheres, LocalDate dateFinEncheres, Integer miseAPrix, Long noVendeur, Long noCategorie) {
    ...
    public ArticleVenduDTO(Long noArticle, String nom, String description, LocalDate dateDebutEncheres, LocalDate dateFinEncheres, Integer miseAPrix, Integer prixVente, Long noVendeur, Long noCategorie, Long noAcheteur) {
        this.noArticle = noArticle;
        this.nom = nom;
        this.description = description;
        this.dateDebutEncheres = dateDebutEncheres;
