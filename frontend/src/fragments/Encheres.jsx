        ...
        <form action="/" method="get">
          <div className="row mx-auto mb-4">
              ...
              <div className="d-none d-md-block">
                <div className="row d-flex justify-content-center mb-3">
                  <div className="col-auto">
                    <button type="submit" className="btn-icons">
                  ...
                  <div className="col-8">
                    <select value="categorie" className="dropdown w-100">
                      {categories.data.map((cat, index) => (
                        <option key={index} value={cat.libelle}>
                          {cat.libelle}
                        </option>
                      ))}
                    </select>
                  ...
                  <div className="col-6 p-0">
                    <div className="form-check">
                      <input
                        ...
                        id="achatsRadio"
                        checked
                        onClick="selectForm('formAchats')"
                      />
                      <label className="form-check-label" htmlFor="achatsRadio">
                    ...
                    <div id="formAchats" className="container mb-3">
                      <div>
                        ...
                        />
                        <label className="critere" htmlFor="encheresOuvertes">
                          enchères ouvertes
                        </label>
                      </div>
                      <div>
                        ...
                        />
                        <label className="critere" htmlFor="encheresEnCours">
                      ...
                      <div>
                        ...
                        />
                        <label className="critere" htmlFor="encheresRemportees">
                  ...
                  <div className="col-6 p-0">
                    <div className="form-check">
                      <input
                        ...
                        name="formSelection"
                        id="ventesRadio"
                        onClick="selectForm('formVentes')"
                      />
                      <label className="form-check-label" htmlFor="ventesRadio">
                    ...
                    <div id="formVentes" className="container mb-3">
                      <div>
                        <input
                          ...
                          value="ventesEnCours"
                        />
                        <label className="critere" htmlFor="ventesEnCours">
                          mes ventes en cours
                        </label>
                      </div>
                      <div>
                        ...
                        />
                        <label className="critere" htmlFor="ventesNonDebutees">
                          ventes non débutées
                        </label>
                      </div>
                      <div>
                        ...
                        />
                        <label className="critere" htmlFor="ventesTerminees">
                          ventes terminées
                        </label>
                      </div>
                    </div>
            ...
            <div className="col-md-6 mb-4 p-0 d-flex justify-content-center align-items-center">
              <button className="btn btn-secondary w-75 h-100" type="submit">
                Rechercher
              </button>
            </div>
          </div>
        ...
        <div className="row mx-auto d-flex justify-content-between">
          {articles.map((article, index) => (
            <UnArticle
              key={article.id}
              article={article}
              retrait={trouverRetrait(article.noArticle)}
              index={index}
            />
          ))}
        </div>
...
Encheres.propTypes = {
  ...
  retraits: PropTypes.arrayOf(PropTypes.any),
